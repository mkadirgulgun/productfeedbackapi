...
namespace ProductFeedback.Migrations
{
    ...
    [Migration("20241030125144_userRel-UserVote")]
    partial class userRelUserVote
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductFeedback.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProductFeedback.Model.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductFeedback.Model.Comment", b =>
                {
                    ...
                    b.HasOne("ProductFeedback.Model.Comment", "Reply")
                        .WithMany()
                        .HasForeignKey("ReplyId");

                    b.HasOne("ProductFeedback.Model.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
